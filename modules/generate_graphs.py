...
def generate_html_graphs():
    ...
    def releng_html():
        ...
        if VERBOSE:
            print("Rebuilding RelEng Graph Data.")

        py.offline.plot(fig, include_plotlyjs="cdn", filename="./static/releng.html", auto_open=False)

    def aws_html():
        df = pd.read_csv("./csv_data/aws_provisioner_data.csv")
        ...
        if VERBOSE:
            print("Rebuilding AWS Graph Data.")

        py.offline.plot(fig, include_plotlyjs="cdn", filename="./static/aws.html", auto_open=False)
